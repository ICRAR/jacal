...
class TestIceMetadataSourceService(unittest.TestCase):
    ...
    def test(self):
        ...
        ice_metadata_source_service_runner = service_runner_factory.get_service_runner(IceMetadataSourceService, {"name":"ice_metadata_source_service", "metadata_endpoint": metadata_stream.get_endpoint(), "control_endpoint": control_stream.get_endpoint()}, configuration_stream=configuration_stream)

        metadata_string_stream = messager.get_stream(messaging_system, "metadatastring", StringMessage)
        tostring_service_runner = service_runner_factory.get_service_runner(ToStringService, {"name":"tostring_service", "input_endpoint":metadata_stream.get_endpoint(), "output_endpoint":metadata_string_stream.get_endpoint(), "control_endpoint":control_stream.get_endpoint()}, configuration_stream=configuration_stream)

        string_writer_service_runner = service_runner_factory.get_service_runner(StringWriterService, {"name":"string_writer_service", "string_endpoint":metadata_string_stream.get_endpoint(), "control_endpoint":control_stream.get_endpoint()}, configuration_stream=configuration_stream)
