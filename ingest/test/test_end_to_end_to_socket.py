...
class TestAlignService(unittest.TestCase):
    ...
    def test(self):
        ...
        # set up the socket writer service
        socket_writer_service_runner = service_runner_factory.get_service_runner(SocketWriterService, {"name": "socket_writer_service", "input_endpoint": uvw_chunk_stream.get_read_endpoint(), "control_endpoint": control_stream.get_read_endpoint(), "input_class": UVWChunk}, configuration_stream=configuration_stream)

        uvw_chunk_from_socket_stream = messager.get_stream(messaging_system, "uvwchunkfromsocket", UVWChunk)

        socket_reader_service_runner = service_runner_factory.get_service_runner(SocketReaderService, {"name": "socket_reader_service", "output_endpoint": uvw_chunk_from_socket_stream.get_write_endpoint(), "control_endpoint": control_stream.get_read_endpoint(), "output_class": UVWChunk}, configuration_stream=configuration_stream)
        ...
        to_string_service_runner = service_runner_factory.get_service_runner(ToStringService, {"name": "to_string_service", "input_endpoint":uvw_chunk_from_socket_stream.get_read_endpoint(), "output_endpoint": uvw_chunk_string_stream.get_write_endpoint(), "control_endpoint":control_stream.get_read_endpoint()}, metrics_stream=to_string_metrics_stream, configuration_stream=configuration_stream)
