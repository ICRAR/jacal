...
for f in fl:
    ...
    if (len(a)==(1024*1024*1024)):
      a.shape=(1024,1024,1024)
      #a=a.T ## Check this
      aa=np.reshape(a,(1024,1024,1024),order='F')
      aa=np.reshape(aa,(N3,1024/N3,N2,1024/N2,N1,1024/N1),order='F')
      b=aa.mean(5).mean(3).mean(1)
      n=6
      pl.figure(1)
      pl.clf()
      pl.imshow(a.T[n*int(1024/N1)])
      pl.title('Original plane %d'%(n*N1))
      pl.figure(2)
      pl.clf()
      pl.imshow(b.T[n])
