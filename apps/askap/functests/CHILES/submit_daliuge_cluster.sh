...
MYCLUSTER=$JACAL_HOME"/apps/askap/functests/spectral_line/start_dfms_cluster.py"

LG_GRAPH=$JACAL_HOME"/apps/askap/functests/spectral_line/askap_SpectralLine_galaxy.json"
