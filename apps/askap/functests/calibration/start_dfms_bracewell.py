...
import uuid
import dlg
from dlg import deploy
from dlg.deploy import pawsey 
from dlg.deploy.pawsey import dfms_proxy
from dlg import utils, tool
from dlg.dropmake import pg_generator
from dlg.manager import cmdline
from dlg.manager.client import NodeManagerClient, DataIslandManagerClient
from dlg.manager.constants import NODE_DEFAULT_REST_PORT, \
...
VERBOSITY = '5'
logger = logging.getLogger('deploy.bracewell.cluster')
apps = (
    None,
